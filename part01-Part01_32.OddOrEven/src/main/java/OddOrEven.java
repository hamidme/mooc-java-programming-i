...
public class OddOrEven {
    ...
    public static void main(String[] args) {
        ...
        // So, by taking the modulo of a number and two you can find out if it
        //is even or odd !
        
        System.out.println("Give a number");
        int userNum = Integer.valueOf(scan.nextLine());
        if(userNum%2 == 0){
            System.out.println(String.format("Number %s is even.", userNum));
        } else {
            System.out.println(String.format("Number %s is odd.", userNum));
        }
    }
}
